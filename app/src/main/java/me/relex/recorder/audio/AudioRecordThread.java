...
import me.relex.recorder.tools.BufferedRandomAccessFile;
...
public class AudioRecordThread extends Thread {
    ...
    public AudioRecordThread(File file) {
        super();
        mFile = file;
        mMiniBuffer = AudioRecord.getMinBufferSize(SAMPLES_PER_SEC, AudioFormat.CHANNEL_IN_STEREO,
    ...
    private void createAudioRecord() {
        if (mAudioRecord == null) {
            mAudioRecord = new AudioRecord(MediaRecorder.AudioSource.MIC, SAMPLES_PER_SEC,
                    AudioFormat.CHANNEL_IN_STEREO, AudioFormat.ENCODING_PCM_16BIT, mMiniBuffer);
        }
    }
